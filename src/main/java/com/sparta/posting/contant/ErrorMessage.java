package com.sparta.posting.contant;
...
public class ErrorMessage {
    ...
    public static final String WRONG_ADMIN_PASSWORD = "관리자 패스워드가 틀려 등록이 불가능합니다.";
    public static final String WRONG_PASSWORD = "패스워드가 틀렸습니다.";
    public static final String WRONG_JWT_TOKEN = "JWT Token이 잘못되었습니다.";
}
