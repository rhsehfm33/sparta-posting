...
public class BoardService {
    ...
    @Transactional
    public BoardOuterResponseDto createBoard(BoardRequestDto boardRequestDto, UserDetailsImpl userDetails) {
        ...
        return BoardOuterResponseDto.of(newBoard);
    }
    ...
    @Transactional
    public BoardOuterResponseDto update(
            Long id,
        ...
        return BoardOuterResponseDto.of(board);
    }
    ...
    @Transactional
    public BoardOuterResponseDto toggleBoardLike(Long boardId, UserDetailsImpl userDetailsImpl) throws AccessDeniedException {
        User user = userRepository.findByUsername(userDetailsImpl.getUsername()).orElseThrow(
                () -> new EntityNotFoundException(ErrorMessage.USER_NOT_FOUND.getMessage())
        );
